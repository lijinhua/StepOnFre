 ...
 */
abstract class AbstractDemoChartForMain implements IChartForMain {
...
//			PointStyle[] styles, Boolean screenLarge) {
...
//			renderer.setMargins(new int[] { 10, 30, 0, 10 });
//		}
//
...
//	}
	 ...
	 */
//	protected DefaultRenderer buildCategoryRenderer(int[] colors, boolean screenLarge) {
...
//			renderer.setMargins(new int[] { 20, 50, 50, 10 }); // WL change
//		} else {
//			renderer.setLabelsTextSize(11); // For small screen
//			renderer.setLegendTextSize(11);
//			renderer.setMargins(new int[] { 10, 30, 0, 10 });
//		}
...
//	}
	 ...
	 */
	XYMultipleSeriesDataset buildBarDataset(String[] titles,
											List<double[]> values) {
		XYMultipleSeriesDataset dataset = new XYMultipleSeriesDataset();
		int length = titles.length;
...
//			}
	 ...
	 */
	XYMultipleSeriesRenderer buildBarRenderer(int[] colors,
											  boolean screenLarge) {
		XYMultipleSeriesRenderer renderer = new XYMultipleSeriesRenderer();
		...
		if (screenLarge) {
			...
			renderer.setChartTitleTextSize(22);
			renderer.setLabelsTextSize(18);
			renderer.setLegendTextSize(22); // WL size change
		} else {
			renderer.setMargins(new int[] { 10, 30, 0, 10 }); // For smaller
																// screen Aug.
																// 31
