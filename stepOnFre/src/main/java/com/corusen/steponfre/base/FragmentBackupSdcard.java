...
public class FragmentBackupSdcard extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mView = inflater.inflate(AccuService.mScreenFragmentBackupSdcard, container,
				false);
	...
	public void updateDisplay() {
		...
		if (res != null) { // java.lang.NullPointerException in TE
			...
			mButtonExport.setImageDrawable(getActivity().getResources()
					.getDrawable(AccuService.mScreenBackupDBExport));
			mButtonImport.setImageDrawable(getActivity().getResources()
