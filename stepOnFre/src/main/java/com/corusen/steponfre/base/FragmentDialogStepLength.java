...
public class FragmentDialogStepLength extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (isMetric) {
            numberPicker.setMinValue(FragmentSettings.WALK_MIN);
            numberPicker.setMaxValue(FragmentSettings.WALK_MAX);
        } else {
            numberPicker.setMinValue((int) ((float) FragmentSettings.WALK_MIN * Utils.CM2INCH));
            numberPicker.setMaxValue((int) ((float) FragmentSettings.WALK_MAX * Utils.CM2INCH));
        }
