...
public class DailyActiveEndTime extends DialogPreference {
	    ...
	    public DailyActiveEndTime(Context ctxt) {
	        this(ctxt, null);
	    }

	    public DailyActiveEndTime(Context ctxt, AttributeSet attrs) {
	        this(ctxt, attrs, 0);
	    }

	    public DailyActiveEndTime(Context ctxt, AttributeSet attrs, int defStyle) {
