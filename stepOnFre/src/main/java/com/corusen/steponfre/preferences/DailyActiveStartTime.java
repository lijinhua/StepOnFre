...
public class DailyActiveStartTime extends DialogPreference {
	    ...
	    public DailyActiveStartTime(Context ctxt) {
	        this(ctxt, null);
	    }

	    public DailyActiveStartTime(Context ctxt, AttributeSet attrs) {
	        this(ctxt, attrs, 0);
	    }

	    public DailyActiveStartTime(Context ctxt, AttributeSet attrs, int defStyle) {
