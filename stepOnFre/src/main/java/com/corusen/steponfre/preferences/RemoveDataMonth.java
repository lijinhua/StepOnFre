...
public class RemoveDataMonth extends DialogPreference {
	    ...
	    public RemoveDataMonth(Context ctxt) {
	        this(ctxt, null);
	    }

	    public RemoveDataMonth(Context ctxt, AttributeSet attrs) {
	        this(ctxt, attrs, 0);
	    }

	    public RemoveDataMonth(Context ctxt, AttributeSet attrs, int defStyle) {
