...
public class RunLengthPreference extends EditTextPreference {
	...
	public RunLengthPreference(Context context) {
		super(context);
	}
	public RunLengthPreference(Context context, AttributeSet attr) {
		super(context, attr);
		initPreferenceDetails();
	}
	public RunLengthPreference(Context context, AttributeSet attr, int defStyle) {
		super(context, attr, defStyle);
		initPreferenceDetails();
	}

	protected void initPreferenceDetails() {
		mTitleResource = R.string.run_length_setting_title;
